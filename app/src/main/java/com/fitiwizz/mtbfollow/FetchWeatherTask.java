...
import com.fitiwizz.mtbfollow.data.WeatherContract;
import com.fitiwizz.mtbfollow.data.WeatherContract.WeatherEntry;
...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    private String formatHighLows(double high, double low) {
        ...
        String unitType = sharedPrefs.getString(
                mContext.getString(R.string.unitKey),
                mContext.getString(R.string.unitDefault));
